...
Rectangle {
    ...
    // Color palette for UnicornCommander Light (Windows-style)
    readonly property color primaryColor: "#0078d4"
    readonly property color accentColor: "#7c3aed"
    readonly property color backgroundColor: "#f3f4f6"
    ...
    Image {
        ...
        // Light acrylic-style blur overlay
        FastBlur {
            anchors.fill: parent
            source: wallpaper
            radius: 60
    ...
    Repeater {
        ...
        Rectangle {
            ...
            height: width
            radius: width / 2
            color: Qt.rgba(accentColor.r, accentColor.g, accentColor.b, Math.random() * 0.3 + 0.1)
            x: Math.random() * root.width
            y: Math.random() * root.height
            
            SequentialAnimation on opacity {
                loops: Animation.Infinite
                NumberAnimation { to: 0.2; duration: 5000 + Math.random() * 3000 }
                NumberAnimation { to: 0.4; duration: 5000 + Math.random() * 3000 }
            }
            ...
            SequentialAnimation on y {
                ...
                NumberAnimation { 
                    ...
                    duration: 15000 + Math.random() * 7000
