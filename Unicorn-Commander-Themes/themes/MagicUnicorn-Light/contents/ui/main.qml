...
Item {
    ...
    property string name: "UnicornCommander Mac Light"
    property string description: "macOS-style layout with light theme and UnicornCommander branding"
    ...
    property string colorScheme: "UCMacLight"
    ...
    Component.onCompleted: {
        console.log("UnicornCommander Mac Light theme loaded")
    }
}