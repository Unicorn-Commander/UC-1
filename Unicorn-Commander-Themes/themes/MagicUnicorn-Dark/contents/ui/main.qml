...
Item {
    ...
    property string name: "UnicornCommander Mac Dark"
    property string description: "macOS-style layout with dark theme and UnicornCommander branding"
    ...
    property string colorScheme: "UCMacDark"
    ...
    Component.onCompleted: {
        console.log("UnicornCommander Mac Dark theme loaded")
    }
}
