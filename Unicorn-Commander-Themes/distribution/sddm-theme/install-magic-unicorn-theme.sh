...
# MagicUnicorn SDDM Theme Installation Script
# Elegant macOS-inspired login theme with clean design
...
echo -e "${PURPLE}🦄 MagicUnicorn SDDM Theme Installer${NC}"
echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
if [ -d "$INSTALL_DIR" ]; then
    echo -e "${YELLOW}⚠️  Removing existing MagicUnicorn theme...${NC}"
    rm -rf "$INSTALL_DIR"
fi
...
if [ -f "$INSTALL_DIR/Main.qml" ] && [ -f "$INSTALL_DIR/metadata.desktop" ]; then
    echo ""
    echo -e "${GREEN}✅ MagicUnicorn SDDM theme installed successfully!${NC}"
    echo ""
    ...
    echo ""
    echo -e "${PURPLE}🦄 The magical login experience awaits! ✨${NC}"
else
